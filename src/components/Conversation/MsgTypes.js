import { Typography, Divider, Stack, Box, Link, IconButton} from '@mui/material'
...
const DocMsg = ({el}) => {
    ...
    return (
        ...
        >
            <Box p={1.5} sx={{backgroundColor: el.incoming ? theme.palette.background.default : theme.palette.primary.main,
            borderRadius: 1.5,
            width: "max-content",
            }}>
                <Stack spacing={2}>
                    <Stack p={2} direction="row" spacing={3} alignItems="center" sx={{backgroundColor: theme.palette.background.paper,
                        borderRadius: 1}}
                        >
                            <Image size={48}/>
            ...
            width: "max-content",
                ...
                <Stack spacing={2}>
                    ...
                    >
                        ...
                        />
                        <Stack spacing={2}>
                        <Typography variant="subtitle2">Creating Mental Health App</Typography>
